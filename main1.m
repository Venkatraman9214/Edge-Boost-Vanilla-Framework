...
%             end
        ...
        % 统计队长增量
        if ii==1
            Q_Outputs(jj,ii)=ReqTmp(jj);
        else
            Q_Outputs(jj,ii)=Q_Outputs(jj,ii-1)+ReqTmp(jj);
        end
    end
    ...
    Delay(ii+1) = Delay(ii) + totalInf - totalSat;
end